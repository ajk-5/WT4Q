...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Northeast.Models.AstrologyHoroscope", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("CosmicWeather")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("AstrologyHoroscopes");
                });

            modelBuilder.Entity("Northeast.Models.AstrologySignForecast", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("GuidanceAdventure")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("GuidanceReflection")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("GuidanceRitual")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("OutlookCareer")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("OutlookGeneral")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("OutlookLove")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("OutlookWellness")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("RelationsPeople")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("RelationsPets")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("RelationsPlanets")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("RelationsStars")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("RelationsStones")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("HoroscopeId", "SignId")
                        .IsUnique();

                    b.ToTable("AstrologySignForecasts");
                });

            modelBuilder.Entity("Northeast.Models.AstrologySubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateOnly?>("LastSentForDate")
                        .HasColumnType("date");
                    ...
                    b.ToTable("AstrologySubscriptions");
                });

            modelBuilder.Entity("Northeast.Models.AstrologySignForecast", b =>
                {
                    b.HasOne("Northeast.Models.AstrologyHoroscope", "Horoscope")
                        .WithMany("Signs")
            ...
            modelBuilder.Entity("Northeast.Models.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
