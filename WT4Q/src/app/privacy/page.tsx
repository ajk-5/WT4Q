...
export const metadata: Metadata = {
  ...
  description: "Understand how The Nineties Times (90sTimes) protects reader data, manages cookies, and stays compliant with GDPR, CCPA, and global privacy standards.",
  keywords: [
    'privacy policy 2025',
  ...
  openGraph: {
    ...
    description: "See how The Nineties Times safeguards your personal data, manages analytics, and honors opt-out requests across the globe.",
    url: '/privacy',
    type: 'article',
  },
  twitter: {
    card: 'summary',
    title: 'The Nineties Times Privacy Policy',
    description: "Review our updated privacy terms, cookie consent details, and reader data protections for 2025.",
  },
};
